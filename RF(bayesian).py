...
#Stratifiedkfold cv için recall score döndüren funct.
...
#RandomForest için Optimizasyon Fonksiyonu
...
rf_düz = RandomForestClassifier()
rf_düz.fit(X_train,y_train)
tahminler = rf_düz.predict(X_test)
